...
class function THTMLNodeGraphBuilder.nextTag(s:ansistring;var o:integer;l:integer):TLocationData;
var done:boolean; 
    qo,dqo:boolean; 
begin
...
class function THTMLNodeGraphBuilder.nextTag(s:ansistring;var o:integer;l:integer;var nontagchars:ansistring):TLocationData;
var done:boolean; 
    qo,dqo:boolean; 
begin
     while s[o]<>'<' do
...
class function THTMLNodeGraphBuilder.Analyze(s:string):TTag;
...
class function THTMLNodeGraphBuilder.FileOpenAndReadEveryFuckingThingAsOneFuckingLine(name:ansistring):ansistring;
var f:text; 
    c:ansistring; 
begin
     assign(f,name);
...
class function THTMLNodeGraphBuilder.getSubTagValue(tag:TTag;subname:ansistring):ansistring;
var p:ansistring; 
    i:integer; 
begin
     p:=UpCase(subname);
...
class function THTMLNodeGraphBuilder.ParseFileName(filename:ansistring):ansistring;
var i:integer; 
begin
