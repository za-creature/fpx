...
type
  ...
  TEditorStyleDialog = class(TForm)
    ...
    procedure BGColorLabelClick(Sender: TObject);
    procedure FGColorClick(Sender: TObject);
    procedure BGColorClick(Sender: TObject);
    procedure FGColorLabelClick(Sender: TObject);
...
procedure TEditorStyleDialog.BGColorLabelClick(Sender: TObject);
begin
  BGColorClick(Sender);
end;
...
procedure TEditorStyleDialog.FGColorLabelClick(Sender: TObject);
begin
  FGColorClick(Sender);
end;
